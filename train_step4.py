...
def class_train_step4(feature_extractor,disentangler,classifier,data1,data2,data3,data4,label1,label2,label3,label4):
    ...
    cr_grads1 = t.gradient(cr_loss1, w1+w2+w3)
    cr_grads2 = t.gradient(cr_loss2, w1+w2+w3)
    cr_grads3 = t.gradient(cr_loss3, w1+w2+w3)
    cr_grads4 = t.gradient(cr_loss4, w1+w2+w3)
    optimizer.apply_gradients(zip(cr_grads1, w1+w2+w3))
    optimizer.apply_gradients(zip(cr_grads2, w1+w2+w3))
    optimizer.apply_gradients(zip(cr_grads3, w1+w2+w3))
    optimizer.apply_gradients(zip(cr_grads4, w1+w2+w3))
    
    #extract the class-irrelevant features by adversarial training
    ci_grads1 = t.gradient(ci_loss1, w2+w3)
    ci_grads2 = t.gradient(ci_loss2, w2+w3)
    ci_grads3 = t.gradient(ci_loss3, w2+w3)
    ci_grads4 = t.gradient(ci_loss4, w2+w3)
    ie_grads1 = t.gradient(ie_loss1, w2)
    ie_grads2 = t.gradient(ie_loss2, w2)
    ie_grads3 = t.gradient(ie_loss3, w2)
    ie_grads4 = t.gradient(ie_loss4, w2)
    optimizer.apply_gradients(zip(ci_grads1, w2+w3))
    optimizer.apply_gradients(zip(ci_grads2, w2+w3))
    optimizer.apply_gradients(zip(ci_grads3, w2+w3)) 
    optimizer.apply_gradients(zip(ci_grads4, w2+w3)) 
    optimizer.apply_gradients(zip(ie_grads1, w2))
    optimizer.apply_gradients(zip(ie_grads2, w2))
    optimizer.apply_gradients(zip(ie_grads3, w2))
    optimizer.apply_gradients(zip(ie_grads4, w2))
...
def mi_re_train_step4(feature_extractor,disentangler,reconstructor,net,data1,data2,data3,data4,label1,label2,label3,label4):
    with tf.GradientTape(persistent=True) as t:
        fe1= feature_extractor(data1,training = True)
        fe2= feature_extractor(data2,training = True)
        fe3= feature_extractor(data3,training = True)
    ...
    max_grads2 = t.gradient(mi_loss2, w2)
    max_grads3 = t.gradient(mi_loss3, w2)
    max_grads4 = t.gradient(mi_loss4, w2) 
    optimizer.apply_gradients(zip(max_grads1, w2))
    optimizer.apply_gradients(zip(max_grads2, w2))
    optimizer.apply_gradients(zip(max_grads3, w2))     
    optimizer.apply_gradients(zip(max_grads4, w2))     
    
    # reconstructe the class_irrelevant features and the class_rrelevant features
    re_grads1 = t.gradient(re_loss1, w2+w4)
    re_grads2 = t.gradient(re_loss2, w2+w4)
    re_grads3 = t.gradient(re_loss3, w2+w4)
    re_grads4 = t.gradient(re_loss4, w2+w4)
    optimizer.apply_gradients(zip(re_grads1, w2+w4))
    optimizer.apply_gradients(zip(re_grads2, w2+w4))
    optimizer.apply_gradients(zip(re_grads3, w2+w4))
    optimizer.apply_gradients(zip(re_grads4, w2+w4))
...
def dc_train_step4(feature_extractor,disentangler,data1,data2,data3,data4,label1,label2,label3,label4):
    with tf.GradientTape(persistent=True) as t:
        fe1= feature_extractor(data1,training = True)
        fe2= feature_extractor(data2,training = True)
        fe3= feature_extractor(data3,training = True)
    ...
    w2=disentangler.variables
    # separate the class_irrelevant features and the class_rrelevant features
    dc_grads1 = t.gradient(dc_loss1, w1+w2)
    dc_grads2 = t.gradient(dc_loss2, w1+w2)
    dc_grads3 = t.gradient(dc_loss3, w1+w2)
    dc_grads4 = t.gradient(dc_loss4, w1+w2)
    dc_grads5 = t.gradient(dc_loss5, w1+w2)
    dc_grads6 = t.gradient(dc_loss6, w1+w2)    
    adc_grads  = t.gradient(adc_loss, w1+w2)
    optimizer.apply_gradients(zip(dc_grads1, w1+w2))
    optimizer.apply_gradients(zip(dc_grads2, w1+w2))
    optimizer.apply_gradients(zip(dc_grads3, w1+w2))
    optimizer.apply_gradients(zip(dc_grads4, w1+w2))
    optimizer.apply_gradients(zip(dc_grads5, w1+w2))
    optimizer.apply_gradients(zip(dc_grads6, w1+w2))
    optimizer.apply_gradients(zip(adc_grads, w1+w2))
...
def train4 (feature_extractor,disentangler,reconstructor,classifier,net,all_number,class_number,mi_re_number,dc_number,dataset,print_gap):
    for all_epoch in range(all_number):
        for class_epoch in range (class_number):
            for (batch, (data1,data2,data3,data4,label1,label2,label3,label4)) in enumerate(dataset):
                class_train_step4(feature_extractor,disentangler,classifier,data1,data2,data3,data4,label1,label2,label3,label4)
        ...
        for mi_re_epoch in range (mi_re_number):
            for (batch, (data1,data2,data3,data4,label1,label2,label3,label4)) in enumerate(dataset):
                mi_re_train_step4(feature_extractor,disentangler,reconstructor,net,data1,data2,data3,data4,label1,label2,label3,label4)
        ...
        for dc_epoch in range (dc_number):
            for (batch, (data1,data2,data3,data4,label1,label2,label3,label4)) in enumerate(dataset):
                dc_train_step4(feature_extractor,disentangler,data1,data2,data3,data4,label1,label2,label3,label4)
